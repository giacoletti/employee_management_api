...
namespace EmployeeManagement.Test
{
    public class MoqTests
    {
        ...
        public void CreateInternalEmployee_InternalEmployeeCreated_SuggestedBonusMustBeCalculated() 
        {
            ...
            var employeeManagementTestDataRepository = new EmployeeManagementTestDataRepository();
            var employeeFactoryMock = new Mock<EmployeeFactory>();
            // when defining multiple match rules, the last one matched is applied
            employeeFactoryMock.Setup(m =>
                ...
                .Returns(new InternalEmployee("Kevin", "Docx", 5, 2500, false, 1));
            employeeFactoryMock.Setup(m =>
                m.CreateEmployee(
                    "Sandy",
                    It.IsAny<string>(),
                ...
                .Returns(new InternalEmployee("Sandy", "Docx", 0, 3000, false, 1));
            employeeFactoryMock.Setup(m =>
                m.CreateEmployee(
                ...
                .Returns(new InternalEmployee("SomeoneWithAnA", "Docx", 5, 3000, false, 1));
            var employeeService = new EmployeeService(
                employeeManagementTestDataRepository,
                employeeFactoryMock.Object);
